...
Funcionalidade: Cadastro de Projetos
  ...
  Contexto:
    ...
    E que eu esteja logado como o usuário "colaborador1@test.com"
  ...
  Cenário: Acessando a lista de projetos
    ...
    E eu devo ver uma linha para o projeto "Projeto 2"
    E eu não devo ver o link "Adicionar Projeto"

  Cenário: Acessando a página do Projeto 1
    Dado que eu visite a url "/projetos"
    Quando eu clicar no botão de visualizar o registro "Projeto 1"
    Então eu não devo ver o link "Adicionar Tarefa"
    E eu não devo ver o link "Editar Projeto"
    E eu devo ver uma lista com 2 tarefas
    E eu devo ver uma linha para a tarefa "Tarefa 1"
    E eu não devo ver um botão de editar para o registro "Tarefa 1"
    E eu devo ver uma linha para a tarefa "Tarefa 2"
    E eu não devo ver um botão de editar para o registro "Tarefa 2"
  ...
  #   E eu não devo ver o link "Remover Tarefa"
